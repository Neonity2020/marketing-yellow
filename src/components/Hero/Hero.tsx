    ...
    <>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 min-h-[700px] md:min-h-[600px]">
          ...
          <div className="space-y-5 flex flex-col justify-center md:items-start md:text-left py-20 px-10 md:pr-24 md:py-0 md:px-0">
            <motion.h1
            ...
            <motion.button
              ...
              initial="initial"
              animate="animate"
              className=" bg-gray-900 text-white hover:bg-amber-500 duration-300 py-2 px-4 rounded shadow-sm hover:shadow-md"
            >
              More News
            </motion.button>
          </div>
